...
#           Support Vector Regression model with ‘nu-radial’ kernel.
...
# Try out the DecisionTreeRegressor model
DT_model = DecisionTreeRegressor(splitter="best", max_depth=None, random_state=13)
DT_model.fit(X_train, y_train)
print("DT_model: ", DT_model.score(X_vali, y_vali))

# Try out the SGDRegressor model
SGD_model = SGDRegressor(max_iter=1000, random_state=None)
SGD_model.fit(X_train, y_train)
print("SGD_model: ", SGD_model.score(X_vali, y_vali))

# Try out the MLPRegressor model
MLP_model = MLPRegressor(shuffle=True, random_state=None)
MLP_model.fit(X_train, y_train)
print("MLP_model: ", MLP_model.score(X_vali, y_vali))

# Try out the Support Vector Regression model - other research says this model works well with this data
SVR_model = SVR(kernel="rbf", degree=3)
SVR_model.fit(X_train, y_train)
print("SVR_model with kernel = rbf: ", SVR_model.score(X_vali, y_vali))

SVR_model = SVR(kernel="linear", degree=3)
SVR_model.fit(X_train, y_train)
print("SVR_model with kernel = linear: ", SVR_model.score(X_vali, y_vali))

SVR_model = SVR(kernel="poly", degree=3)
SVR_model.fit(X_train, y_train)
print("SVR_model with kernel = poly: ", SVR_model.score(X_vali, y_vali))
